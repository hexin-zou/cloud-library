...
import com.example.springboot.feign.TokenFeign;
import com.example.springboot.api.request.BookPageRequest;
...
public class BookController {
    ...
    public Result uploadFile(MultipartFile file) {
        ...
        try {
            ...
            Admin currentAdmin = tokenFeign.getCurrentAdmin();
            String token = tokenFeign.genToken(currentAdmin);
    ...
    public Book getByNo(@PathVariable String bookNo) {
        Book book = bookService.getByNo(bookNo);
        return book;
    }

    @PutMapping("/updateById")
    public void updateById(@RequestBody Book user) {
        bookService.updateById(user);
    }

    @PutMapping("/{updateNumByNo}")
    public void updateNumByNo(@PathVariable String bookNo) {
        bookService.updateNumByNo(bookNo);
    }
